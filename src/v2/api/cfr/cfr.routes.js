...
const Cfrs = __importStar(require("./cfr.handlers"));
const cfr_model_1 = require("./cfr.model");
const router = (0, express_1.Router)();
router.get('/', Cfrs.findAll);
router.get('/findByQuery', Cfrs.findByYearOrMonth);
router.get('/push', Cfrs.pushCfr);
...
router.delete('/deleteall', Cfrs.deleteAll);
router.delete('/:id', (0, middlewares_1.validateRequest)({
    params: ParamsWithId_1.ParamsWithId,
}), Cfrs.deleteOne);
exports.default = router;
//# sourceMappingURL=cfr.routes.js.map