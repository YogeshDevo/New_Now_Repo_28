...
exports.Todo = z.object({
    ...
    set_points: z
        ...
        reading_string: z.any().optional(),
        eq_reading_string: z.any().optional(),
        before_for_adjustment_string: z.any().optional(),
        before_string: z.any().optional(),
        eq_after_string: z.any().optional(),
        after_string: z.any().optional(),
    }))
        .optional(),
    //new setpoints
    set_points_table: z
