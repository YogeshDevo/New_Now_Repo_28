...
const tracing_1 = __importDefault(require("../../../prisma/tracing"));
(0, tracing_1.default)('GIL-CMS');
...
const lock_instruments_routes_1 = __importDefault(require("./lock-instruments/lock-instruments.routes"));
...
const metrics_route_1 = __importDefault(require("./metrics/metrics.route"));
const env_data_routes_1 = __importDefault(require("./env-data/env-data.routes"));
...
router.use('/mutex', lock_instruments_routes_1.default);
...
router.use('/envdata', env_data_routes_1.default);
router.use('/metrics', metrics_route_1.default);
