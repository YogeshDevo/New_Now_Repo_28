...
const TodoHandlers = __importStar(require("./ins_master.handlers"));
const ins_master_model_1 = require("./ins-master.model");
const router = (0, express_1.Router)();
//
router.get('/count', TodoHandlers.findAllCount);
router.get('/allcount', TodoHandlers.getMachineCounts);
//
router.get('/', TodoHandlers.findAll);
router.get('/many', TodoHandlers.findByPage);
...
//# sourceMappingURL=ins-master.routes.js.map