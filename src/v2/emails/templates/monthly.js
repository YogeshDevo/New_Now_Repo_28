...
exports.EmailMonthlyTemplate = void 0;
function EmailMonthlyTemplate(content = [], logoURL = 'https://ik.imagekit.io/psrmathur/GIL-logo-hr.jpg?updatedAt=1712053508443', companyName = 'Granules India Limited') {
    return `<!doctype html>
                  ...
                  <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:24px;font-weight:bold;line-height:1;text-align:center;color:#0EA7F9;">Calibration schedule for the current month</div>
                          </td>
                       </tr>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
...
exports.EmailMonthlyTemplate = EmailMonthlyTemplate;
