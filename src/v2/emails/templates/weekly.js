...
exports.EmailWeeklyTemplate = void 0;
function EmailWeeklyTemplate(content = [], logoURL = 'https://ik.imagekit.io/psrmathur/GIL-logo-hr.jpg?updatedAt=1712053508443', companyName = 'Granules India Limited') {
    return `<!doctype html>
    ...
    <body style="word-spacing:normal;background-color:#D5EAF7;">
      <div style="background-color:#D5EAF7;">
        <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" bgcolor="transparent" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                  ...
                  <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                      <tbody>
                              ...
                              <tbody>
                                <tr>
                                  <td style="width:180px;">
                                    <img height="auto" src="${logoURL}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="180" />
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                        ...
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:24px;font-weight:bold;line-height:1;text-align:center;color:#0EA7F9;">${companyName}</div>
                          </td>
                        </tr>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:24px;font-weight:bold;line-height:1;text-align:center;color:#0EA7F9;">Below requests were created in the last week and waiting for approval</div>
                          </td>
                      </tr>

                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <p style="border-top:solid 4px #7C96A5;font-size:1px;margin:0px auto;width:100%;">
                            </p>
                            <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 4px #7C96A5;font-size:1px;margin:0px auto;width:550px;" role="presentation" width="550px" ><tr><td style="height:0;line-height:0;"> &nbsp;
    </td></tr></table><![endif]-->
                          </td>
                        </tr>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;padding-top:24px;padding-bottom:24px;word-break:break-word;">
                            <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;line-height:1.2;text-align:center;color:#3C454A;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                              <thead>
                                <tr>
                                  <td style="border: 1px solid gray;">Instrument Description</td>
                                  <td style="border: 1px solid gray;">Instrument ID</td>
                                  <td style="border: 1px solid gray;">Instrument Location</td>
                                </tr>
                              </thead>
                              <tbody>
                                ${content.map((row) => {
        return ` <tr>
        <td style="width:180px;border: 1px solid blue;">
          ${row.instrument_desc}
        </td>
        <td style="width:180px;border: 1px solid blue;">
          ${row.instrument_id}
      ...
      <td style="width:180px;border: 1px solid blue;">
        ...
        <div style="margin:0px auto;max-width:600px;">
          <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
            <tbody>
              <tr>
                <td style="border-left:1px white solid;border-right:1px white solid;direction:ltr;font-size:0px;padding:6px;text-align:center;">
        ...
        <div style="margin:0px auto;max-width:600px;">
          <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
            <tbody>
              <tr>
                <td style="border-bottom:1px white solid;border-left:1px white solid;border-right:1px white solid;direction:ltr;font-size:0px;padding:24px;padding-top:0px;text-align:center;">
...
exports.EmailWeeklyTemplate = EmailWeeklyTemplate;
