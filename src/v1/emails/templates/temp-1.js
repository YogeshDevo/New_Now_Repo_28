...
function EmailTemplate(content = '', logoURL = 'https://ik.imagekit.io/psrmathur/GIL-logo-hr.jpg?updatedAt=1712053508443', companyName = 'Granules India Limited') {
    return `<!doctype html>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;padding-top:24px;padding-bottom:24px;word-break:break-word;">
                            <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;line-height:1.2;text-align:center;color:#3C454A;">${content}</div>
                          </td>
                        </tr>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
...
//# sourceMappingURL=temp-1.js.map